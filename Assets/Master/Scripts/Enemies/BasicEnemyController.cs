...
public class BasicEnemyController : MonoBehaviour
{
    ...
    private void UpdateMovingState()
    {
        ...
        {
            mov.Set(movSpeed * facingDir, aliverb.velocity.y);
            aliverb.velocity = mov;
        }
    }
    ...
    private void EnterKnockbackState()
    {
        ...
        mov.Set(knockbackSpeed.x * damageDir, knockbackSpeed.y);
        aliverb.velocity = mov;
    ...
    private void CheckTouchDamage()
    {
        if(Time.time >= lastTouchDamageTime + touchDamageCooldown)
        {
            ...
            Collider2D hit = Physics2D.OverlapArea(touchDamageBotLeft, touchDamageTopRight, player);
